...
void main() {
  group('SecretRedactor', () {
    test('redacts bearer tokens', () {
      const input =
          'Authorization: Bearer abcdefghijklmnop.1234567890'; // secret-scan: allow
    ...
    test('redacts common credential assignments while preserving key names', () {
      const input =
          'password="super-secret-value" api_key=abc123456789 token:xyz987654321'; // secret-scan: allow
    ...
    test('redacts secret query parameters without destroying the URL', () {
      const input =
          'https://example.test/path?mode=play&access_token=abc123456789&lang=en'; // secret-scan: allow
    ...
    test('redacts Windows and Unix user-specific paths', () {
      const input =
          'C:\\Users\\Example\\AppData\\Local\\app.log /home/example/project/file.dart'; // secret-scan: allow
    ...
    test(
      'does not redact ordinary diagnostics or Google public test ad ids',
      () {
        const input =
