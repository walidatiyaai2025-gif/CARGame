...
| C | Shared motion, ambient home/world scenes, feedback, transitions, lifecycle/interruption safety | Immediate feedback, reduced motion, no leaks, safe interruption. |
