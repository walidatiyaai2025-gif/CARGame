...
- The tracking-only reconciliation that follows the implementation head changes no production behavior; final-head Flutter CI is required before PR #184 is marked ready and merged.
