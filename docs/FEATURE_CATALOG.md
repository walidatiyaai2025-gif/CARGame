...
- `PRIV-003` User data export/deletion readiness — P1; `PRIV-001` is VERIFIED and `ENG-008` is IMPLEMENTED. Completing the first-party reset/export/delete contract removes the remaining repository-owned data-control prerequisite for `TEST-011` while production UMP/privacy-message verification remains external.
