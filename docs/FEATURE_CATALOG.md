...
| AST-004 | Precache and memory policy | P1 | VERIFIED | AST-002 | Issue #192 / PR #193 harden the bounded asset cache with shared same-ID in-flight operations, global/per-ID invalidation so clear/forget cannot be undone by late completion, bounded LRU/failure state, explicit near-future retry policy, immutable observability counters, safe eviction failures, and machine ownership gates that reject raw production `precacheImage` bypasses. Final PR head `61c5741ba8340e0baafb2d2cea9989137b25a279` passed Flutter CI #839 / run `31408977215`: AST-004 focused tests 14/14, validator regressions 6/6, full 320-test Flutter suite, 88.34% authored-source coverage, Debug APK and artifact security/upload; artifact #9071093253 is 80,633,602 bytes with SHA-256 `0e6da3e6d75212817f22c91592009e97532d838f4f395a4f4f1c9f488a59f5bb`. PR #193 squash-merged as `22239a6cdd7af3770a03a4b9a86e8d32d078a01b`; exact-main Flutter CI #840 / run `31409971405` repeated 320 tests, 88.34% coverage, Debug APK, artifact security and upload. Main artifact #9071436511 is 80,633,603 bytes with artifact ZIP SHA-256 `b7150ca0969b0f32e3741ca4a47e9c51e7c8d6ce02880af9d47b5f1cfbfec562`. Latest-verified promotion run `31410745473` succeeded and committed `4379937b51309644a11bffc43d7375888e258823`; the QA release APK is 55,878,023 bytes with SHA-256 `df60e5bc0471cdf99ab66a3e01987cc7948fc52ba353da647070b29bcd137a72`, ephemeral CI signing, ads disabled, and is not production/Play Store signed. Asset admission remains 9 descriptors / 0 provenance / 0 runtime WebP, so fallback-safe runtime behavior is unchanged. |
...
| TEST-008 | Coverage thresholds and flaky-test policy | P1 | VERIFIED | ENG-007 | Issue #190 / PR #191 add a versioned authored-source coverage and flaky-test contract: strict LCOV parsing, 35% hard floor, 60% target, zero blanket retries, bounded owner/issue/expiry quarantines, and 30 focused regressions. Final clean PR head `456c762818e6b1e0746651ef6f9b3cefcbb32dea` passed Flutter CI #835 / run `31405428616`; PR #191 squash-merged as `87ab162c1fe1a73b962dd98370ac04aee7d15b90`, Issue #190 closed completed, and exact-merge main CI #836 / run `31406357471` passed all gates with debug artifact #9070055072 (80,633,605 bytes; artifact ZIP SHA-256 `5b66f915d19184feda6ca2a061e73fdaaa6abed4ac6cc9b2c2002c3c33e9a476`). The full suite passed 310 tests at 88.01% authored-source line coverage (5,584/6,345). Latest-verified promotion run `31407149670` committed the 55,878,023-byte QA release APK with SHA-256 `adf8907ad545b6c30113c17eabbd4d8a572c79d3821b05212cee0f562468f64a` as promotion commit `3945b6fad174ec913c381fabfc8788de4e5323d7`; ephemeral CI signing and ads disabled remain QA-only. |
...
- `AST-004` Precache and memory policy — issue #192 / PR #193 complete the 100-checkpoint cache hardening sprint. Final PR head `61c5741ba8340e0baafb2d2cea9989137b25a279` passed Flutter CI #839 / run `31408977215` with 14/14 focused cache tests, 6/6 validator regressions, 320 Flutter tests, 88.34% authored-source coverage, Debug APK, artifact security and upload; artifact #9071093253 is 80,633,602 bytes with SHA-256 `0e6da3e6d75212817f22c91592009e97532d838f4f395a4f4f1c9f488a59f5bb`. PR #193 squash-merged as `22239a6cdd7af3770a03a4b9a86e8d32d078a01b`; exact-main Flutter CI #840 / run `31409971405` repeated all gates and uploaded artifact #9071436511 (80,633,603 bytes; artifact ZIP SHA-256 `b7150ca0969b0f32e3741ca4a47e9c51e7c8d6ce02880af9d47b5f1cfbfec562`). Latest-verified promotion run `31410745473` succeeded and committed `4379937b51309644a11bffc43d7375888e258823`; the QA release APK is 55,878,023 bytes with SHA-256 `df60e5bc0471cdf99ab66a3e01987cc7948fc52ba353da647070b29bcd137a72`, ephemeral CI signing, ads disabled, and is not production/Play Store signed.
- `TEST-008` Coverage thresholds and flaky-test policy — issue #190 / PR #191 completed the 50-checkpoint quality sprint. Clean-head CI #835 / run `31405428616` and exact-merge main CI #836 / run `31406357471` passed TEST-007/TEST-010, privacy/security/dependency, Analyze, 310 Flutter tests, 88.01% authored-source line coverage, Debug APK, artifact security, and upload; main debug artifact #9070055072 is 80,633,605 bytes with artifact ZIP SHA-256 `5b66f915d19184feda6ca2a061e73fdaaa6abed4ac6cc9b2c2002c3c33e9a476`. PR #191 squash-merged as `87ab162c1fe1a73b962dd98370ac04aee7d15b90`, Issue #190 closed completed, and latest-verified promotion run `31407149670` committed QA APK promotion `3945b6fad174ec913c381fabfc8788de4e5323d7` (55,878,023 bytes; SHA-256 `adf8907ad545b6c30113c17eabbd4d8a572c79d3821b05212cee0f562468f64a`).
- `TEST-010` Dashboard/catalog parser validation — issue #187 / PR #188 are completed and merged. Final clean-head CI #827 / run `31385221550` and exact-merge main CI #828 / run `31385904664` each passed all 45 steps; main debug artifact #9061890276 is 80,633,607 bytes with SHA-256 `a2684e4697cf2e153ee75f471cc1bfeaaf0feb15638e43a788984c2bc585b173`. Latest-verified promotion run `31386487136` produced the 55,878,023-byte release-mode QA APK with SHA-256 `7b24570855c3e3f48007f53eac9770cde3a6a9fe0de519abff35fcb36925383f` and committed it as `743356b2a8e66b699feadb09e1c9f5fa60b858a7`.
